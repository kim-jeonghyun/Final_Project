...
--lr 0.00003 --niter 100 --niter_decay 100 --resize_or_crop None --verbose --tf_log --batchSize 8 --num_gpus 1 --label_nc 21 --launcher pytorch \
--save_epoch_freq 4 # --continue_train
